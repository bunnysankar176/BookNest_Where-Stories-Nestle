...
import { Users, Store, BookOpen, ShoppingBag } from "lucide-react";
import {
...
function AdminStats() {
  ...
  // Helper to format "2026-02" into "2026 - Feb"
  ...
  // Helper to format Date nicely to "Feb 22, 2026"
      ...
      <div className="kpi-grid">
        ...
        <div className="kpi-card">
          <div className="kpi-icon-wrapper bg-purple-light">
            <Store size={24} className="text-purple" />
          </div>
          <div className="kpi-info">
            <p className="kpi-label">Total Sellers</p>
            <h3 className="kpi-value">{stats.approvedSellers ?? 0}</h3>
          </div>
        </div>
            ...
            <ResponsiveContainer width="100%" height={280}>
              <BarChart data={orderStatusData} margin={{ top: 20, right: 10, left: -20, bottom: 0 }}>
                ...
                <Bar dataKey="count" fill="#6366f1" radius={[4, 4, 0, 0]} barSize={40}>
                  {/* Added persistent count labels on top of bars */}
            ...
            <ResponsiveContainer width="100%" height={280}>
              <LineChart data={monthlyRevenueData} margin={{ top: 25, right: 20, left: -20, bottom: 0 }}>
                ...
                <Line type="monotone" dataKey="revenue" stroke="#10b981" strokeWidth={3} dot={{ r: 4, fill: '#10b981', strokeWidth: 2, stroke: '#fff' }} activeDot={{ r: 6 }}>
                  {/* Added persistent revenue labels with Rupees symbol */}
              ...
              {recentOrders.length > 0 ? (
                recentOrders.map((o) => (
                  <tr key={o._id}>
                    ...
                    <td>
                      {/* Enforced lowercase to ensure CSS mapping works perfectly */}
